    ...
    <head>
        ...
        <style>
            ...
            .header-section {
                ...
                border-radius: 12px;
                margin-bottom: 20px;
                box-shadow: 0 0px 10px rgba(182, 227, 136, 0.3);
            }
            ...
            .drop-zone {
                ...
                padding: 10px;
                text-align: center;
                background: linear-gradient(135deg, rgba(182, 227, 136, 0.05), rgba(128, 201, 4, 0.05));
                margin-bottom: 6px;
                cursor: pointer;
                border-radius: 12px;
                transition: all 0.1s ease;
            ...
            .drop-zone::before {
                ...
                width: 100%;
                height: 100%;
                background: linear-gradient(90deg, transparent, rgba(182, 227, 136, 0.1), transparent);
            ...
            .drop-zone:hover {
                background: linear-gradient(135deg, rgba(182, 227, 136, 0.1), rgba(128, 201, 4, 0.1));
                border-color: #80C904;
            }
            ...
            .table-section h2 {
                ...
                margin-bottom: 15px;
                padding-bottom: 8px;
                border-bottom: 3px solid #B6E388;
        ...
        <div class="main-container">
            <div class="header-section">
                <div class="d-flex justify-content-between align-items-center">
                    <h2><i class="bi bi-gear-fill me-2"></i>Admin Costume Project</h2>
                    <div class="top-buttons">
                        ...
                        <a href="costume_index.php" target="_blank">
