    ...
    <head>
        ...
        <style>
            ...
            .current-images-section {
                background: rgba(182, 227, 136, 0.05);
                border-radius: 12px;
                padding: 20px;
                margin-top: 15px;
                border: 2px dashed rgba(182, 227, 136, 0.2);
            }
            ...
            .btn-group-modern {
                ...
                margin-top: 30px;
                padding-top: 20px;
                border-top: 2px solid rgba(182, 227, 136, 0.1);
            }
        ...
        <div class="main-container">
            <div class="header-section">
                <div class="floating-buttons">
                    ...
                    <a href="costume_admin.php" class="floating-btn">
